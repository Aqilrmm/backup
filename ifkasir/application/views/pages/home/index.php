    ...
    <div class="card-group">
                ...
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium"><?php echo getJumlahKaryawan(); ?> Orang</h2>
                        </div>
                ...
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">
                            <sup class="set-doller overflow-auto">Rp.</sup><?= number_format(getTodayEarning() ?? 0, 0, ',', '.') ?>
                        </h2>
        ...
        <div class="card border-right">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium"><?php echo getTodayCountSales(); ?></h2>
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <h2 class="text-dark mb-1 font-weight-medium"><?php echo getCountMenu(); ?></h2>
                ...
                <div class="card-body">
                    ...
                    <script>
                        ...
                        <?php foreach ($list_penjualan_seminggu as $row) : ?>
                            ...
                            total.push(<?php echo $row->total / 100000; ?>);
                        <?php endforeach ?>
                    </script>
                </div>
            </div>
                    ...
                    <div class="mt-4 activity">
                        <?php foreach ($list_penjualan as $row) : ?>
                            <div class="d-flex align-items-start border-left-line pb-3">
                                <div>
                                    <a href="<?php echo base_url("sales/detail/$row->id_penjualan"); ?>" class="btn btn-info btn-circle mb-2 btn-item">
                                        <i data-feather="shopping-cart"></i>
                                    </a>
                                </div>
                                <div class="ml-3 mt-2">
                                    <h5 class="text-dark font-weight-medium mb-2">Penjualan Nomor <?php echo $row->id_penjualan; ?></h5>
                                    <p class="font-14 mb-2 text-muted">
                                        Dilayani oleh <?= $row->nama ?>
                                        <br>
                                        Rp.<?php echo number_format($row->total_harga, 0, ',', '.'); ?>,-
                                    </p>
                                    <span class="font-weight-light font-14 text-muted"><?php echo $row->waktu_penjualan; ?></span>
                                </div>
                            </div>
                        <?php endforeach ?>
                        <a href="<?php echo base_url('sales'); ?>" class="font-14 border-bottom pb-1 border-info">Load More</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table no-wrap v-middle mb-0">
                            ...
                            <tbody>
                                <?php foreach ($users as $row) : ?>
                                    <tr>
                                        <td class="border-top-0 px-2 py-4"><?php echo $row->nama; ?></td>
                                        <td class="border-top-0 text-muted px-2 py-4 font-14"><?php echo $row->email; ?></td>
                                        <!-- Hanya admin yang boleh liat KTP -->
                                        <?php if ($this->session->userdata('role') == 'admin') : ?>
                                            <td class="border-top-0 text-muted px-2 py-4 font-14"><?php echo $row->ktp; ?></td>
                                        <?php endif ?>
                                        ...
                                        <td class="border-top-0 text-center text-muted px-2 py-4"><?php echo $row->telefon; ?></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                        </table>
                ...
                <div class="card-footer bg-white">
                    <div class="row mb-3">
                        <div class="col-md-12 col-sm-12 mb-2">
                            <a href="<?php echo base_url('users'); ?>" class="btn btn-primary btn-rounded text-white float-right">Lihat Daftar Karyawan <i class="fas fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
